            ...
            <div class="content" data-slug="panel1">
              ...
              <table>
                ...
                <tbody>
                  ...
                  <?php for($i=0; $i< count($user_access); $i++) { ?>
                  <tr>
                    <td><?php echo $user_access[$i]['id'] ?></td>
                    <td><?php echo $user_access[$i]['nombre'] ?></td>
                    <td><?php echo $user_access[$i]['correo'] ?></td>
                    <?//Se generan dos botones, que redireccionan a acutalizaar y eliminar respectivamente."?>
                    <td><a href="./update.php?id=<?php echo($user_access[$i]['id']); ?>" class="button radius tiny warning"">Modificar</a></td>
                    <td><a href="./delete.php?id=<?php echo($user_access[$i]['id']); ?>" class="button radius tiny alert" onClick="wait();">Eliminar</a></td>
                  </tr>
                  <?php } ?>
                  <tr>
